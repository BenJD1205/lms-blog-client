export const styles = {
    ...
    button: 'flex flex-row justify-center items-center py-3 px-6 rounded-full w-full cursor-pointer bg-[#2190ff] min-h-[45px] text-[16px] font-Poppins font-semibold',
}